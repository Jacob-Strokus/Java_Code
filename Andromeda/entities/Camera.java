...
public class Camera {
	...
	public Camera(Warrior player) {
		this.player = player;
	}
	
	public Camera(Wizard player) {
		this.player = player;
	}
	
	public Camera(Archer player) {
		this.player = player;
	}
	
	public Camera(Assassin player) {
		this.player = player;
	}
	
	public Camera(Theif player) {
		this.player = player;
	}
	...
	public float rotate() {
		...
		float angleChange = player.getPosition().x * 0.0013f;
		return angleAroundPlayer -= angleChange;
	}
