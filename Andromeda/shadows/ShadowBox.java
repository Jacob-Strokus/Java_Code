...
public class ShadowBox {
	...
	private static final float OFFSET = 16;
	...
	/**
	 * Creates a new shadow box and calculates some initial values relating to the
	 * camera's view frustum, namely the width and height of the near plane and
	 * (possibly adjusted) far plane.
	 * 
	...
	/**
	 * Calculates the position of the vertex at each corner of the view frustum in
	...
	/**
	 * Calculates one of the corner vertices of the view frustum in world space and
	 * converts it to light space.
	 * 
	 * @param startPoint
	 ...
	 * view frustum. This doesn't have to use the "actual" far plane of the
	 * view frustum. It can use a shortened view frustum if desired by bringing the
	 * far-plane closer, which would increase shadow resolution but means that
	 * distant objects wouldn't cast shadows.
	 */
