...
public class NormalMappingShader extends Shader{
    ...
    private static final String VERTEX_FILE = "src/normalMappingRenderer/normalMapVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/normalMappingRenderer/normalMapFragmentShader.txt";
