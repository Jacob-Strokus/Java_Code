...
public class Loader {
	...
	public ParticleVao createEmptyVAO(int maxParticles) {
		int vaoID = createVAO();
		int vbo = createEmptyVbo(maxParticles);
		unbindVAO();
		return new ParticleVao(vaoID, vbo, this);
	}
	...
	public void updateVbo(int vbo, float[] data, FloatBuffer buffer) {
		buffer.clear();
		buffer.put(data);
		buffer.flip(); // ready to read instead instead of write
		GL15.glBindBuffer(GL15.GL_ARRAY_BUFFER, vbo);
