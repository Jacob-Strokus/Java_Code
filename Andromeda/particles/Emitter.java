...
public class Emitter implements Cloneable 
{
	...
	public Emitter( double x, double y, double z, boolean cont,  int num, int r, BufferedImage[] im)
	{
	...
	public void emit()
	{
		...
		{
			Particle2 x = new Particle2(loc.x,loc.y,0,null);
			if(images != null)
			{
