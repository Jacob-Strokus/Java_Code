...
public class Particle2 {
	...
	public Particle2( double x, double y, double z, BufferedImage i)
	{
	...
	public Particle2( double x, double y, double z, double vx, double vy, double vz, BufferedImage i)
	{
		loc = new Vector3D( x, y, z);
	...
	public Particle2( double x, double y, double z, double vx, double vy, double vz, double ax, double ay, double az, BufferedImage i)
	{
		loc = new Vector3D( x, y, z);
		velocity = new Vector3D(vx, vy, vz);
	...
	{
		if(loc.x > x2+size || loc.x < x1 - size || loc.y < y1 - size|| loc.y > y2 + size)
		{
			return true;
		}
		return false;
