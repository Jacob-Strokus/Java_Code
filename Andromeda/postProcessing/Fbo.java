...
public class Fbo {
	...
	/**
	 * Creates an FBO of a specified width and height, with multi-sampled depth buffeer
	 * @param width
	 *            - the width of the FBO.
	 * @param height
	 *            - the height of the FBO.
	...
	/**
	 *  Process of resolving multi-sampled Fbo back to normal Fbo so I can render the texture to the screen
	 * @param outputFbo 
	 * 				-the normalized texture containing both multi-sampled depth and color buffers
	 */
	...
	/**
	 *  resolves mutli-sampled texture buffer straight to the screen
	 */
	...
	/**
	 * Adds a color buffer to the FBO in the form of a render buffer. 
	 */
	public void createMultisampleColorAttachment() {
